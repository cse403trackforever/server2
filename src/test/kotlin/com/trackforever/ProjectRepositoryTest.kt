...
class ProjectRepositoryTest {
    ...
    fun setup() {
        ...
        val issueNoComments = TrackForeverIssue("issueHash123", "", "issue123", "testproj2", "fixed", listOf("defect", "bug"),
                listOf(), "Not Will", listOf("Will"), 1234, 1235, 1337)
    ...
    fun testIssuesCorrect() {
        ...
        assert(projectRepository.findById("testproj2").get().issues["issue123comments"] == TrackForeverIssue("issueHash123comments", "", "issue123comments", "testproj2", "wontfix", listOf("defect", "bug"), listOf(TrackForeverComment("Will", "Why won't you fix this?"), TrackForeverComment("Not Will", "Because I said so.")), "Will", listOf(), null, null, null)) { "Issue: \"issue123comments\" is stored incorrectly." }
        assert(projectRepository.findById("testproj2").get().issues["issue123"] == TrackForeverIssue("issueHash123", "", "issue123", "testproj2", "fixed", listOf("defect", "bug"), listOf(), "Not Will", listOf("Will"), 1234, 1235, 1337)) { "Issue: \"issue123\" is stored incorrectly." }
    }
